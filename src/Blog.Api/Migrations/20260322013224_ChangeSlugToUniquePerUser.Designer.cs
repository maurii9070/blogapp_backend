...
namespace Blog.Api.Migrations
{
    ...
    [Migration("20260322013224_ChangeSlugToUniquePerUser")]
    partial class ChangeSlugToUniquePerUser
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Blog.Api.Entities.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("Blog.Api.Entities.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Blog.Api.Entities.Post", b =>
                {
                    ...
                    b.HasIndex("AuthorId", "Slug")
                        .IsUnique()
                        .HasDatabaseName("ix_posts_author_id_slug");

                    b.ToTable("posts", (string)null);
                });

            modelBuilder.Entity("Blog.Api.Entities.Tag", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Blog.Api.Entities.Comment", b =>
                {
                    ...
                    b.HasOne("Blog.Api.Entities.ApplicationUser", "User")
                        .WithMany("Comments")
            ...
            modelBuilder.Entity("Blog.Api.Entities.Post", b =>
                {
                    b.HasOne("Blog.Api.Entities.ApplicationUser", "Author")
                        .WithMany("Posts")
                    ...
                    b.HasOne("Blog.Api.Entities.Category", "Category")
                        .WithMany("Posts")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Blog.Api.Entities.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
            ...
            modelBuilder.Entity("PostTag", b =>
                {
                    ...
                    b.HasOne("Blog.Api.Entities.Tag", null)
                        .WithMany()
